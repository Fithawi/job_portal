                    ...
                    <div class="widget-content widget-content-area p-4">
                        ...
                        <div class="tab-content" id="simpletabContent">
                            <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1-tab">
                                <form method="POST" action="{{ route('admin.DoEditUser',$row->id) }}" class="form-horizontal add_user_personal" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" placeholder="Confirm Password" name="cpassword" id="cpassword" value="{{old('cpassword')}}">
